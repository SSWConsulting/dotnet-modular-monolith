...
using Modules.Warehouse.Products.Commands.CreateProduct;
// using Modules.Warehouse.Products.Queries.GetProducts;

namespace Modules.Warehouse.Products.Endpoints;
